...
<html>
  ...
  <body>
    <nav class="navbar navbar-default" role="navigation">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="citiques.php">Critiques</a></li>
        </ul>
    ...
    <?php
      ...
      $Query = "SELECT " . return_attributes("Critiques") . " FROM critiques, person, movie WHERE critiques.person_id=person.id AND critiques.movie_id=movie.id";
      display_query($Query, "Critiques");
    ?> 
