...
<html>
  ...
  <body>
    <nav class="navbar navbar-default" role="navigation">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="directors.php">Directors</a></li>
        </ul>
    ...
    <?php
      ...
      $Query = "SELECT " . return_attributes("Director") . " FROM person, directs WHERE directs.person_id = person.id";
      display_query($Query, "Director");
    ?> 
